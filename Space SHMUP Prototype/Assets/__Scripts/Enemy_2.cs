...
public class Enemy_2 : Enemy
{
    ...
    //Определяют, насколько ярко будет выражен синусоидальный характе движения
    public float sinEccentricity = 0.6f;
    public float lifeTime = 10;

    [Header("Set Dynamically: Enemy_2")]
    //Enemy_2 использует линейную интерполяцию между двумя точками,
    //изменяя результат по синусойде
    public Vector3 p0;
    public Vector3 p1;
    ...
    void Start()
    {
        ...
        //Случайно поменять наальную и конечную точку местами
    ...
    public override void Move()
    {
        ...
        //Скорректировать u добавлением значения кривой, изменяющейся по синусойде
