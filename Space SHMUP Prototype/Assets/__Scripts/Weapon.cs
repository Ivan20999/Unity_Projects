...
/// Так же включает тип "shield", чтобы дать возможность совершенствовать зашиту.
...
public enum WeaponType
{
    ...
    spread,     //Веерная пушка,стреляющая нескольки снарядами
    phaser,     //[HP] Волновой фазер
    missile,    //[HP] Самонаводящая ракета
...
public class Weapon : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            GameObject go = new GameObject("_PjectileAnchor");
    ...
    public void Fire()
    {
        ...
        switch (type)
        {
            ...
            case WeaponType.spread:
                ...
                p = MakeProjectile(); //Снаряд, летщий влево
                p.transform.rotation = Quaternion.AngleAxis(-10, Vector3.back);
                p.rigid.velocity = p.transform.rotation * vel;
                break;
        }
