...
public class MissionDemolition : MonoBehaviour
{
    ...
    public TextMeshProUGUI uitLevel; //Ссылка на обьект UIText_Level
    public TextMeshProUGUI uitShots; //Ссылка на обьект UIText_Shots
    public TextMeshProUGUI uitButton; //Ссылка на дочерний обьект Text в UIButton_View
    public Vector3 castlePos; //Местоположение замка
    public GameObject[] castles; //Массив замков

    [Header("Set Dynamically")]
    public int level; //Текущий уровень
    public int levelMax; //Колличество уровней
    public int shotsTaken;
    public GameObject castle; //Текущий замок
    public GameMode mode = GameMode.idle;
    public string showing = "Show Slingshot"; //Режим FolloCam
