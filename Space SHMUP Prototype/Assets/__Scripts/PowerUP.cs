...
public class PowerUP : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        //Random.onUnitSphere возвращает вектор, указывающий на случаную 
        ...
        //с использованием rotMinMax.x и rotMinMax.y
    ...
    private void Update()
    {
        ...
        //Эффект растворения куба PowerUp c течением времени
        ...
        //положительное и через fadeTime секунд станет больше одного.
        ...
        if (u > 0)
        {
            ...
            //Буква тоже должна раствориться, но медленнее
            c = letter.color;
            c.a = 1f - (u * 0.5f);
            letter.color = c;
        }
        ...
        {
            //Если бонус полность вышел за границу экрана, уничтожить его
            Destroy(gameObject);
        }
    }
    public void SetType(WeaponType wt)
    {
        ...
        type = wt;//В заключениии установить фактический тип
    }
    ...
    public void AbsorbedBy(GameObject target)
    {
        ...
        //размеры в течении нескольких кадров, но пока просто уничтожим
        //this.gameObject;
        Destroy(this.gameObject);
    }
}
