...
{
    //Enemmy_3 расширяет класс Enemy
    //Траектория движения Enemy_3 вычисляется путем линейной 
    //интерполяции кривой Безье по более двум точкам.
    ...
    void Start()
    {
        ...
        //Запись в bithTime текущее время
        birthTime = Time.time;
    }
    ...
    public override void Move()
    {
        ...
        if (u > 1)
        {
            //Зтот экземпляр Enemy_2 завершил свой жизненный цикл
